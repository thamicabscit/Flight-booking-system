...
public class Flight {
	...
	return "Flight [id=" + id + ", departure_location=" + departure_location + ", arrival_location="
		+ arrival_location + ", flightname=" + flightname + ", arrival_time=" + arrival_time
		+ ", departure_time=" + departure_time + ", amount=" + amount + "]";
    }
//@Id
//private int id;
//private String departure_location;
