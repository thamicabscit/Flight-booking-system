...
public class Booking {
	...
	return "Booking [booking_id=" + booking_id + ", departure_date=" + departure_date + ", booking_date="
		+ booking_date + ", flight=" + flight + ", passenger=" + passenger + ", total_amount=" + total_amount
		+ ", otp=" + otp + ", booking_cancelled=" + booking_cancelled + ", checked_in=" + checked_in
