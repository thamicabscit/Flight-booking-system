...
public class EmailService {
	...
	message.setText("Successfull Booking With PNR Number: " + booking.getBooking_id() + ",  Passegers: "
		+ booking.getPassenger().size() + ",  Departue Details: " + booking.getDeparture_date());
	...
	message.setText("Booking Cancelled for PNR Number: " + booking.getBooking_id()
		+ " If Paid Respective Refund will be initiated shortly (Terms & Conditions Applied)  ");
